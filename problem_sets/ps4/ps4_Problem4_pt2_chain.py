...
param_covar = np.loadtxt('param_covar_tau.txt')
#print(param_covar)
# initial parameters
pars = np.asarray([69, 0.022, 0.12, 0.054, 2.1e-9,0.95])
...
#    print('trial_pars:', trial_pars)
    if trial_pars[3]>(0.054+0.0074) or trial_pars[3]<(0.054-0.0074):
...
np.savetxt('chain_chi_tau.txt', data_mcmc)
