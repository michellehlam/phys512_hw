...
# initialize
m0 = np.asarray([69,0.022,0.12,0.054,2.1e-9,0.95])
...
np.savetxt('planck_fit_params_tau.txt', param_file)
np.savetxt('param_covar_tau.txt', inv_curvature)
